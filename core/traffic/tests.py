...
class TrafficTestCase(TestCase):
    ...
    def connection_db(self):
        ...
        driver = GraphDatabase.driver(
            "bolt://neo4j:7687", auth=("neo4j", "traffic@2684")
        )
        return driver
    ...
    def setUp(self):
        ...
        """
        camera = Cameras.objects.create(name="تست ۱۴۰۴")
    ...
    def test_traffic_log_creation(self):
        ...
        """
        params = {"plate_number": "۳۲ ت ۳۲۲ ۳۲", "camera_id": 1332, "type_id": 2}
    ...
    def test_get_traffic_list(self):
        ...
        params = {"plate_number": "۳۲", "type_id": 2}
    ...
    def test_traffic_suspicious_creation(self):
        ...
        """
        camera = Cameras.objects.create(name="میدان علی")
